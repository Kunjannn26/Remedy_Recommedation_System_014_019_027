...
class allopathyinfo(models.Model):

    patient = models.ForeignKey(patient , null=True, on_delete=models.SET_NULL)

    allopathyremname = models.CharField(max_length = 200)
...
class homeremedyinfo(models.Model):
...
class ayurvedicinfo(models.Model):
...
class SymptomsForm(forms.Form):
    symptoms = forms.CharField(label='Enter Symptoms', max_length=100)
